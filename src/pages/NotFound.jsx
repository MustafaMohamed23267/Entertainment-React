import bladerunner from '../assets/cinema5.jpg'
            ...
            <div className='relative h-screen w-screen overflow-hidden'>
                ...
                <div className='absolute w-full h-full bg-black/50'></div>
                    <div class="text-center relative h-screen flex flex-col items-center justify-center">
                        <p class=" font-bold text-indigo-400 text-4xl">404</p>
                        ...
                        <a href="/" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 duration-300">Go back home</a>
